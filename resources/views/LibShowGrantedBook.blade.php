...
<ul class="navbar-nav">
  ...
  <li class="nav-item">
    <a class="nav-link active" href="/GrantedBooksscreen">GrantedBooks</a>
  </li>
  <li class="nav-item">
...
<div class="card-header" style="background:yellow"> <h2>All Issued Book to Students :</h2>  </div>
  ...
  <table class="table">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>  <form action="BookGranted">
    <input hidden type="number" value="{{$i ->id}}" name="rowid" id="rowid" required>
    <Button class="btn btn-success" name="granted">Accept</Button>   </form> </td> -->
